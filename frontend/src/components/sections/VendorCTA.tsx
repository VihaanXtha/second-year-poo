      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <ScrollReveal direction="scale">
          <div className="relative overflow-hidden rounded-3xl bg-slate-900 px-8 py-16 sm:px-16 sm:py-20">
            ...
            <div className="absolute -bottom-24 -left-24 h-64 w-64 rounded-full bg-teal-600/10 blur-3xl" />
            <div className="relative mx-auto max-w-2xl text-center">
              ...
              >
                <input
                  ...
                  className="flex-1 rounded-xl bg-white/10 px-4 py-3 text-white placeholder-slate-400 ring-1 ring-white/20 focus:outline-none focus:ring-2 focus:ring-red-500 backdrop-blur-sm"
                />
                <button
                  type="submit"
                  className="rounded-xl bg-red-600 px-6 py-3 text-sm font-semibold text-white hover:bg-red-500 transition-all hover:shadow-lg hover:shadow-red-600/30"
                >
