...
const categories: CategoryLink[] = [
  { name: "PC Components", count: 24, icon: "memory", href: "/products?category=pc-components" },
  { name: "IoT Gear", count: 18, icon: "developer_board", href: "/products?category=iot-gear" },
  { name: "Laptops", count: 12, icon: "laptop_mac", href: "/products?category=laptops" },
  { name: "Networking", count: 9, icon: "router", href: "/products?category=networking" },
];
