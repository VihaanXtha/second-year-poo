      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {VENDORS.map((vendor, i) => (
            <ScrollReveal key={vendor.id} direction="up" delay={i * 80}>
              <div
                className="group relative rounded-2xl bg-slate-50 p-6 ring-1 ring-slate-200 hover:ring-red-200 transition-all duration-500 hover:shadow-xl hover:shadow-red-500/5 hover:-translate-y-1"
              >
                <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-white text-2xl font-bold text-slate-900 ring-1 ring-slate-200 group-hover:ring-red-200 transition-all">
                  {vendor.code}
                </div>
