        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {visibleTestimonials.map((t) => (
              <div
                key={t.id}
                className="rounded-2xl bg-white p-8 ring-1 ring-slate-200 shadow-sm"
              >
          ...
          {hasMore && (
            <>
              <button
                onClick={prev}
                className="absolute left-4 top-1/2 -translate-y-1/2 rounded-full bg-white/90 p-2 shadow-lg ring-1 ring-slate-200 hover:bg-white transition-colors"
              ...
              <button
                onClick={next}
                className="absolute right-4 top-1/2 -translate-y-1/2 rounded-full bg-white/90 p-2 shadow-lg ring-1 ring-slate-200 hover:bg-white transition-colors"
