        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <ScrollReveal direction="left">
            <div>
              ...
              <Link
                href="/shop"
                className="mt-8 inline-flex items-center justify-center rounded-xl bg-slate-900 px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-slate-800 transition-all hover:shadow-lg hover:shadow-slate-900/20"
              >
                Start Shopping
          ...
          <ScrollReveal direction="right" delay={150}>
            <div className="relative">
              <div className="aspect-[4/3] rounded-3xl bg-slate-100 overflow-hidden img-zoom">
                <img
              ...
              <div className="absolute -bottom-6 -right-6 h-32 w-32 rounded-2xl bg-red-600/10 -z-10 animate-float3d" />
              <div className="absolute -top-6 -left-6 h-32 w-32 rounded-2xl bg-slate-900/5 -z-10 animate-float3d" style={{ animationDelay: "1s" }} />
            </div>
          </ScrollReveal>
        </div>
      </div>
