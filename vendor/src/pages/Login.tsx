...
export function Login() {
  ...
  if (view === 'forgot') {
    return <ForgotPassword onSuccess={handleForgotSuccess} onBack={() => setView('login')} />;
  }

  if (view === 'verify') {
    return <VerifyOtp email={forgotEmail} onVerified={handleOtpVerified} onBack={() => setView('forgot')} />;
  }

  if (view === 'reset') {
    return <ResetPassword email={forgotEmail} code={resetCode} onSuccess={handleResetSuccess} onBack={() => setView('verify')} />;
  }
